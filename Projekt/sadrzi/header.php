...
// Navigacijski izbornik definiran kao asocijativno polje
$menuItems = [
    'home' => ['name' => 'Početna', 'icon' => '🏠'],
    'radno-vrijeme' => ['name' => 'Radno vrijeme', 'icon' => '🕒'],
    'godisnji-odmori' => ['name' => 'Godišnji odmori', 'icon' => '📅'],
...
<body>
    <!-- Gumb za odjavu u gornjem desnom kutu -->
    ...
    <div class="sidebar">
        ...
        <ul class="menu">
            <?php if (isset($_SESSION['korisnik'])): ?>
                <!-- Prikaz navigacijskih stavki za prijavljene korisnike -->
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <!-- Prikaz samo početne stranice za neprijavljene korisnike -->
